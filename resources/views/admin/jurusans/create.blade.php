...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-slate-800 mb-6">Tambah Jurusan</h1>
    <form method="POST" action="{{ route('admin.jurusans.store') }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            ...
            <div><label class="block text-sm font-medium text-slate-700 mb-1">Singkatan</label><input type="text" name="singkatan" value="{{ old('singkatan') }}" class="w-full px-3 py-2 border border-slate-300 rounded-lg"></div>
        </div>
        ...
        <div><label class="block text-sm font-medium text-slate-700 mb-1">Gambar</label><x-image-cropper name="gambar" folder="jurusans" label="Gambar" aspect="4/3" :outputW="800" :outputH="600" /></div>
        <div class="grid grid-cols-3 gap-4">
            ...
            <div><label class="block text-sm font-medium text-slate-700 mb-1">Warna</label><input type="color" name="warna" value="{{ old('warna', '#3B82F6') }}" class="w-full h-10 border border-slate-300 rounded-lg"></div>
